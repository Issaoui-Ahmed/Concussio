...
// ARCHIVED 2026-07-31 — was components/AdminCompareChatInterface.tsx.
//
// The side-by-side OpenAI vs Fuel IX compare chat, with an OpenAI / Fuel IX / Both selector and
// a per-provider live timer. Retired when the app moved to Fuel IX only: the "openai" and
// "both" provider modes it drives no longer exist in api/chat.py, so this will not work as-is
// if restored. The ChatMessage and Sidebar imports were repointed at @/components (they are
// still live). Not built or linted. See ../README.md.
