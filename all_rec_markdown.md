...
**Recommendation Level of Evidence definitions: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/level-a-legend.png)A = A Consistent, good-quality, patient-oriented evidence (example: at least one large randomized control trial, meta-analysis or systematic review with homogeneity, or large, high- quality, multi-centre cohort study)![](https://pedsconcussion.com/wp-content/uploads/2019/07/level-b-legend.png)B = Inconsistent or limited-quality patient-oriented evidence (example: smaller cohort studies, case studies or control trials with limitations)![](https://pedsconcussion.com/wp-content/uploads/2019/07/level-c-legend.png)C = Consensus, usual practice, opinion or weaker-level evidence**

**Grading of Recommendations Assessment, Development, and Evaluation (GRADE) quality rating definitions: ![](https://pedsconcussion.com/wp-content/uploads/2024/01/1.png)High quality = High quality: further research is very unlikely to change our confidence in the estimate of effect.![](https://pedsconcussion.com/wp-content/uploads/2024/01/2.png)Moderate quality = further research is likely to have an important impact on our confidence in the estimate of effect and may change the estimate.)![](https://pedsconcussion.com/wp-content/uploads/2024/01/3.png)Low quality = further research is very likely to have an important impact on our confidence in the estimate of effect and is likely to change the estimate.![](https://pedsconcussion.com/wp-content/uploads/2024/01/4.png)Very low quality = we are very uncertain about the estimate. (See [GRADE Guidelines](https://doi.org/10.1016/j.jclinepi.2010.04.026))**
...
(Recommendations are adapted from the [Amsterdam International Consensus Statement on Concussion in Sport)](https://bjsm.bmj.com/content/57/11/695)
...
Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)
...
See the [Parachute Statement on Baseline Testing](https://parachute.ca/en/professional-resources/statement-on-concussion-baseline-testing-in-canada/) for more information (Parachute Canada).

“Baseline testing refers to the practice of having an athlete complete certain concussion assessment tools/tests prior to sports participation to provide baseline measurements that can be compared to post-injury values in the event of a suspected concussion. Current evidence does not support a significant added benefit of baseline testing athletes. This includes the Child SCAT5 and the SCAT5 tools, as well as neuropsychological and neurocognitive tests, both computerized or not.” ([Parachute Statement on Baseline Testing](https://parachute.ca/en/professional-resources/statement-on-concussion-baseline-testing-in-canada/))

See [Recommendation 5.3](https://pedsconcussion.com/domain/5/#rec-316): Special considerations regarding baseline testing.

Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png)

5.3

**Special considerations regarding baseline testing.**

Please consult the [Parachute Statement on Baseline Testing](https://parachute.ca/en/professional-resources/statement-on-concussion-baseline-testing-in-canada/) for more information (Parachute Canada).
...
(Reproduced with permission from Parachute Canada: [Parachute Statement on Baseline Testing](https://parachute.ca/en/professional-resources/statement-on-concussion-baseline-testing-in-canada/)).

Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png)

5.4

[Recommendation 2.3d:](https://pedsconcussion.com/domain/2/#rec-614) **Refer select patients (e.g., highly active or competitive athletes, those who are not tolerating a graduated return to physical activity, or those who are slow to recover) to a medically supervised interdisciplinary team with the ability to individually assess sub-symptom threshold aerobic exercise tolerance and to prescribe aerobic exercise treatment.**
...
* Return-to-Sport: Completion of the  [Return to Activity/Sport protocol](https://pedsconcussion.com/return-to-activity-sport-school/) with no symptoms and no clinical findings associated with the current concussion at rest and with maximal physical exertion.
* No longer taking any drugs or substances atypical to their pre-injury functioning that could mask symptom presentation.

For children/adolescents with complex medical histories (e.g., repeated concussion, baseline concussion-like symptoms), see [Recommendation 5.1](https://pedsconcussion.com/domain/5/#rec-314) for information regarding returning to full-contact sports or high-risk activities, or retirement from full-contact sports or high-risk activities.

***Definitions for ‘Complete symptom resolution’, ‘Return-to-Learn, and Return to sport have been harmonized with the [Amsterdam International Consensus Statement on Concussion in Sport](https://bjsm.bmj.com/content/57/11/695))***
...
* [Canadian Guideline on Concussion in Sport – 2nd Edition-  Medical Clearance Letter](https://pedsconcussion.com/wp-content/uploads/2024/03/EN-Clearance-Letter-Parachute.pdf)(Parachute)
* [Concussion Recognition Tool 6.](https://pedsconcussion.com/crt6/) To help identify concussion in children, adolescents, and adults
* [Guideline Return to Sports Protocol](https://pedsconcussion.com/section/sports/pedsconcussion.com/return-to-activity-sport-school/)
* *[Amsterdam](https://bjsm.bmj.com/content/57/11/695)* *[International Consensus Statement on Concussion in Sport (2023)](https://bjsm.bmj.com/content/57/11/695)*

4.2

**Provide patients with a letter indicating medical clearance to return to all activities when medically cleared.**

Link: [Canadian Guideline on Concussion in Sport Medical Clearance Letter](https://parachute.ca/wp-content/uploads/2019/06/Medical-Clearance-Letter.pdf) (Parachute Canada).
...
## Telemedicine and Virtual Concussion Care
...
Tool 15.1: [Considerations for telemedicine and virtual care algorithm](https://pedsconcussion.com/tool-15-1-virtual-care-algorithm/)
...
* American Medical Association.[TeleHealth Quick Guide](https://www.ama-assn.org/practice-management/digital/ama-telehealth-quick-guide) September 2020.
* Canadian Medical Association. [Virtual Care Guide for Patients](https://www.cma.ca/sites/default/files/pdf/Patient-Virtual-Care-Guide-E.pdf). June 2020.
...
* See [Recommendation 2.1a](https://pedsconcussion.com/domain/2/#rec-198) for details that should be collected in the clinical history. This recommendation includes a validated age-appropriate symptom inventory that can be considered as a tool to assess current symptoms and severity.

Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)

15.1c

**See** [**Recommendation 2.b**](https://pedsconcussion.com/domain/2/#rec-196) **“Note common modifiers that may delay recovery and use a clinical risk score to predict risk of prolonged symptoms.”**
...
Tool 15.2: [Considerations for a virtual physical examination for medical assessment and follow-up of concussion patients](https://pedsconcussion.com/tool-15-2-considerations-for-a-virtual-physical-examination/)

Tool 15.3: [Virtual Care Exam Training Resource](https://pedsconcussion.com/vce-manual/). A training manual to assist front-line healthcare professionals who are caring for patients that cannot be seen in person or have already had an in-person assessment and require follow-up.
...
*Link:* [*Recommendation 2.1c*](https://pedsconcussion.com/domain/2/#rec-199) *-recommendations on an in-person medical assessment.*

Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)

15.1f

[***Recommendation 2.1c***](https://pedsconcussion.com/domain/2/#rec-202)***:*** ***“******Consider CT of the brain or cervical spine only in patients whom, after a medical assessment, a structural intracranial or cervical spine injury is suspected; do not conduct routine neuroimaging for the purpose of diagnosing concussion.”***
...
* Link: Tool 2.6: [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/)
* Link: Advice for gradually resuming intellectual, physical and sports activities [English](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_pamphlet_Mild-traumatic-brain-injury.pdf)/ [French](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_Depliant_TCCL_INESSS.pdf)(INESSS)
* Link: [After a Concussion: Return to Sport Strategy](http://test-parachutedev.pantheonsite.io/wp-content/uploads/2017/06/Concussion-ReturnToSport.pdf)(Parachute Canada)
* Link: [HEADS UP Resources for Returning to School](https://www.cdc.gov/heads-up/guidelines/returning-to-school.html)(CDC)
* Link: [Return to Activity Strategy](https://resources.cattonline.com/files/return-to-activity-strategy)(CATT)
* Link: [Return-to-School Strategy](https://resources.cattonline.com/files/return-to-sport-strategy)(CATT)
* Link: [Return to Sport Strategy](https://resources.cattonline.com/files/return-to-sport-strategy)(CATT)
* Link: [Return to School Strategy](https://parachute.ca/wp-content/uploads/2019/06/Return-to-School-Strategy.pdf)(Parachute)
* Link: [Post Concussion Information Sheet for First Nations Youth](https://www.panamclinic.org/wp-content/uploads/2020/01/Post-Concussion-Information-Sheet-First-Nations-Youth.pdf) (Parachute)
* Link: [Post Concussion Information Sheet for Nunavut Youth – French](https://www.panamclinic.org/wp-content/uploads/2020/01/Post-Concussion-Information-Sheet-Nunavut-Youth-French.pdf) (Parachute)
* Link: [Post Concussion Information Sheet for Nunavut Youth – English](https://www.panamclinic.org/wp-content/uploads/2020/01/Post-Concussion-Information-Sheet-Nunavut-Youth-English.pdf) (Parachute)
* Link: [Post Concussion Information Sheet for Nunavut Youth – Inuktitut](https://www.panamclinic.org/wp-content/uploads/2020/01/Post-Concussion-Information-Sheet-Nunavut-Youth-Inuktitut.pdf) (Parachute)
* Link: [**Post Concussion Information Sheet for Nunavut Youth** – Inuinnaqtun](https://www.panamclinic.org/wp-content/uploads/2020/01/Post-Concussion-Information-Sheet-Nunavut-Youth-Inuinnaqtun.pdf) (Parachute)
...
Link: [Canadian Guideline on Concussion in Sport Medical Assessment Letter](https://parachute.ca/wp-content/uploads/2019/09/Medical-Assessment-Letter.pdf)

Link: [Canadian Guideline on Concussion in Sport Medical Clearance Letter](https://parachute.ca/wp-content/uploads/2019/06/Medical-Clearance-Letter.pdf)
...
**Please refer to** [**Domain 3: Medical follow-up and Management of Prolonged Symptoms**](https://pedsconcussion.com/section/a/#domain-3) **for a full list of clinical guideline recommendations to consider when performing a medical follow-up assessment and managing prolonged concussion symptoms.**

15.5

**Please refer to** [**Domain 4: Medical Clearance for full-contact sports and high-risk activities**](https://pedsconcussion.com/section/a/#domain-4) **for a full list of clinical recommendations to consider when determining if a child/adolescent is ready to return to full-contact sports or high-risk activities. Medical clearance is not required to return to school.**
...
* See link for general information on telerehabilitation: TR-Telerehab Toolkit: <https://kite-uhn.com/tools/tr-telerehab-toolkit>
* Alberta Physiotherapy: Telerehabilitation Resource Guide <https://www.physiotherapyalberta.ca/files/guide_telerehabilitation.pdf>
...
See [Recommendation 2.1c](https://pedsconcussion.com/domain/2/#rec-202) for more information on when to consider diagnostic brain or cervical spine imaging.
...
Tool 1.3: [Manage Acute and Prolonged Symptoms Algorithm](https://pedsconcussion.com/manage-acute-and-prolonged-concussion-symptoms-algorithm/)

3.1a

**Take a focused clinical history based on symptoms described.**

* [Headache](https://pedsconcussion.com/section/managing/#domain-headache)
* [Sleep](https://pedsconcussion.com/section/managing/#domain-sleep)
* [Mental Health](https://pedsconcussion.com/section/managing/#domain-mental_health)
* [Cognition](https://pedsconcussion.com/section/managing/#domain-cognition)
* [Vision, Vestibular, and Oculomotor Function](https://pedsconcussion.com/section/managing/#domain-vestibular_oculomotor)
* [Fatigue](https://pedsconcussion.com/section/managing/#domain-fatigue)
* [Return-to-School and Work](https://pedsconcussion.com/section/a/#domain-school_work)
...
* A complete neurological examination (cranial nerve, motor, sensory, reflex, cerebellar, gait, balance testing)
  * [Living Guideline Core Physical Examination: Neurological and Cervical Spine Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/)
...
**[Recommendation 2.1c](https://pedsconcussion.com/domain/2/#rec-202):  Consider diagnostic brain or cervical spine MRI imaging for those with focal or worrisome symptoms.**
...
Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png) MRI
...
* [Living Guideline Post-Concussion Information Sheet](https://pedsconcussion.com/return-to-activity-sport-school/).
* Tool 2.7: [Strategies to Promote Good Sleep and Alertness](https://pedsconcussion.com/tool-2-7-strategies-to-promote-good-sleep-and-alertness/).
* Recommendation 2.3 [Recommend graduated return to cognitive and physical activity](https://pedsconcussion.com/domain/2/#rec-614)
* Recommendations: [Return-to-School and Work](https://pedsconcussion.com/section/a/#domain-school_work).
* Recommendation 2.4c: [Advise on the use of computers, phones, and other screen devices](https://pedsconcussion.com/domain/2/#rec-292).

Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)

Online resources to consider:

* Link: [Sleep for Youth. CHEO Sleep Hygiene handout](https://pedsconcussion.com/cheo-sleep-for-youth-handout/)

3.3

**Encourage patients with post-concussion symptoms to engage in cognitive activity and low-risk physical activity as soon as tolerated  Activities that pose no/low risk of sustaining a concussion (no risk of contact, collision, or falling) should be resumed even if mild residual symptoms are present or whenever acute symptoms improve sufficiently to permit activity.** Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png) Gradual Return to physical activity aerobic exercise treatment. ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png) Gradual return to cognitive activity. See [Recommendation 2.3](https://pedsconcussion.com/domain/2/#rec-614).

* **Refer select patients (e.g., highly-active or competitive athletes, those who are not tolerating a graduated return to physical activity, or those who are slow to recover) following acute injury to a medically supervised interdisciplinary team with the ability to individually assess aerobic exercise tolerance and to prescribe aerobic exercise treatment. This exercise tolerance assessment can be as early as 48 hours following acute injury.** Level of Evidence:![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png)
* **Patients who are active may benefit from referral to a medically supervised interdisciplinary team with the ability to individually assess aerobic exercise tolerance and to prescribe aerobic exercise treatment. This exercise tolerance assessment can be as early as 48 hours following acute injury. Level of Evidence:![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)**

See the Living Guideline [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/) for examples of low-risk activities.

**Exertion test resources:**

1. [Buffalo Concussion Treadmill Test (BCTT) – Instruction Manual](https://ubortho.com/wp-content/uploads/2020/10/Buffalo-Concussion-Treadmill-Test-Manual.pdf)

2. [Buffalo Concussion Bike Test (BCBT) – Instruction Manual](https://ubortho.com/wp-content/uploads/2020/10/BCBT-Test.pdf)

3. [Borg Rating of Perceived Exertion](https://ubortho.com/wp-content/uploads/2020/08/RPE.jpg)

4. [Visual Analog Scale (VAS)](https://ubortho.com/wp-content/uploads/2020/08/VAS.jpg)

Recommendation Updated: Sept 2023

3.4

**Refer patients at elevated risk for delayed recovery to an interdisciplinary concussion team.** Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png)

See Recommendation 2.1b: [Note any modifiers that may delay recovery and use a clinical risk score to predict risk of prolonged symptoms](https://pedsconcussion.com/domain/2/#rec-200).

**Specialized interdisciplinary concussion care is ideally initiated for patients at elevated risk for a delayed recovery within the first two weeks post-injury.** Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png)
...
See Tool 1.3 [Manage Acute and Prolonged Symptoms Algorithm](https://pedsconcussion.com/manage-acute-and-prolonged-concussion-symptoms-algorithm/).

Assessment by an interdisciplinary concussion team can assist in identifying the type of management that is required, along with the medical and health professions on the interdisciplinary concussion team or external to this team who can provide the required management. Not all children/adolescents will require care from all members of the interdisciplinary concussion team and care should be targeted based on identified symptoms and patient needs. Symptoms that persist beyond 4 weeks (persisting symptoms after a concussion (PSAC) previously referred to as persistent post-concussion symptoms (PPCS) may be related to the concussion, due to pre-existing conditions, or both.

Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png)

3.6

**Initiate treatment for specific symptoms or concerns while waiting for a referral to an interdisciplinary concussion team or sub-specialist.**
...
Tool 6.1: [Post-Concussion headache algorithm](https://pedsconcussion.com/tool-6-1-post-concussion-headache-algorithm/).
...
* Psychological or social factors or conditions that can be associated with stress and headaches (e.g., mood or anxiety disorders) (Domain 8: [Mental Health](https://pedsconcussion.com/section/managing/#domain-8)).
...
* Link: [pedMIDAS Headache Severity Tool for Children aged 4-18](https://www.cincinnatichildrens.org/service/h/headache-center/pedmidas).
...
* Vital signs (resting heart rate and blood pressure).
* A complete neurological examination (cranial nerve, motor, sensory, reflex, cerebellar, gait and balance testing) Tool 2.1: [Physical Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/).
* A cervical spine examination (palpation, range of motion, provocative cervical spine tests). Tool 2.1: [Physical Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/).
* With appropriate experience, consider performing an examination of vision, oculomotor and vestibular functioning (Domain 10: [Vision, Vestibular, and Oculomotor Function](https://pedsconcussion.com/section/managing/#domain-vestibular_oculomotor)).
...
Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png) CT. ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png) MRI.
...
Link: [International Classification of Headache Disorders (ICHD-III)](https://www.ichd-3.org/)\*.
...
See [Recommendation 2.3](https://pedsconcussion.com/domain/2/#rec-614).

See Tool 2.6: [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/) for examples of low-risk activities.

Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png) Physical activity. ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png)Cognitive activity.
...
Link: [Headache and Medication Diary](https://pedsconcussion.com/headache-diary-boston-childrens-hospital/) (Boston Children’s Hospital)
...
Tool 6.2: [General Considerations Regarding Pharmacotherapy](https://pedsconcussion.com/tool-6-2-general-considerations-regarding-pharmacotherapy/).

Tool 6.3: [Approved Medications for Pediatric Indications](https://pedsconcussion.com/tool-6-3-approved-medications-for-pediatric-indications/).
...
Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png) Medical follow-up. ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png) Early referral in the presence of modifiers that may delay recovery.
...
See Recommendation 2.2: [Note any modifiers that may delay recovery and use a clinical risk score to predict risk of prolonged symptoms](https://pedsconcussion.com/domain/2/#rec-200).

## Telemedicine and Virtual Concussion Care [https://pedsconcussion.com/section/managing/]
...
Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-A.png)
...
Use Tool 8.1: [Post-concussion mental health considerations algorithm](https://pedsconcussion.com/tool-8-1-post-concussion-mental-health-considerations-algorithm-3/) and refer to a mental health specialist using clinical judgment.

Online resources to consider:

* Link:  [PHQ-SADS (somatic)](https://pedsconcussion.com/phq-sds/)
* Link: [Severity Measure for Depression- Child Age 11–17](https://pedsconcussion.com/dsm5_severity-measure-for-depression-child-age-11-to-17/) (adapted from PHQ-9 modified for Adolescents [PHQ-A])
* Link: [Severity Measure for Generalized Anxiety Disorder-Child Age 11–17](https://pedsconcussion.com/dsm5_severity-measure-for-generalized-anxiety-disorder-child-age-11-to-17/) (adapted from GAD-7)
* Link:  [HEADS-ED Tool](https://www.heads-ed.com/en/survey)—Screening for Pediatric Mental Health (online interactive tool)
* Link:  PROMIS Anxiety (pediatric and parent versions are available via [HealthMeasures.net](http://www.healthmeasures.net/explore-measurement-systems/promis/obtain-administer-measures))
* Link:  PROMIS Depression (pediatric and parent versions are available via [HealthMeasures.net](http://www.healthmeasures.net/explore-measurement-systems/promis/obtain-administer-measures))
* Link:  PROMIS Profile (25 questions, 37 questions, 49 questions versions are available via [HealthMeasures.net](http://www.healthmeasures.net/explore-measurement-systems/promis/obtain-administer-measures))
...
* Ask the child/adolescent and parents and/or caregivers to complete the following, as appropriate:
  * Link:  PROMIS Family Function (pediatric and parent versions are available via [HealthMeasures.net](http://www.healthmeasures.net/explore-measurement-systems/promis/obtain-administer-measures))
  * Link:  [Patient Health Questionnaire (PHQ-9)](https://pedsconcussion.com/phq-9_english/) (Self-administered screen for depression in adults)
  * Link:  [Generalized Anxiety Disorder scale (GAD-7)](https://pedsconcussion.com/gad-7_english/)
...
* Tool 8.1: [Post-Concussion Mental Health Considerations Algorithm](https://pedsconcussion.com/tool-8-1-post-concussion-mental-health-considerations-algorithm-3/).
* Tool 8.2: [Management of Prolonged Mental Health Disorders Algorithm](https://pedsconcussion.com/tool-8-2-2/).
* Tool 6.2: [General Considerations Regarding Pharmacotherapy](https://pedsconcussion.com/tool-6-2-general-considerations-regarding-pharmacotherapy/).
* Tool 6.3: [Approved Medications for Pediatric Indications](https://pedsconcussion.com/tool-6-3-approved-medications-for-pediatric-indications/).
...
For deciding when to refer a child/adolescent to a specialist, use Tool 8.1: [Post-Concussion Mental Health Considerations Algorithm](https://pedsconcussion.com/tool-8-1-post-concussion-mental-health-considerations-algorithm-3/).
...
* Tool 7.1: [Managing post-concussion sleep disturbances algorithm](https://pedsconcussion.com/tool-7-1-prolonged-post-concussion-sleep-disturbances-algorithm/).
...
* Tool 7.2: [Factors that may influence the child/adolescent’s sleep/wake cycle](https://pedsconcussion.com/tool-7-2-factors-that-may-influence-the-child-adolescents-sleep-wake-cycle/).
...
* Link: [Sleep for Youth. CHEO Sleep Hygiene handout](https://pedsconcussion.com/cheo-sleep-for-youth-handout/).
* Link: [Holland Bloorview Kids Rehabilitation Hospital: Concussion Handbook](http://www.hollandbloorview.ca/concussionhandbook).
...
Level of Evidence:  ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png) Gradual return to physical activity. ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-C.png) Gradual return to cognitive activity.
...
* Optimize and implement sleep hygiene (Tool 2.7: [Strategies to Promote Good Sleep and Alertness](https://pedsconcussion.com/tool-2-7-strategies-to-promote-good-sleep-and-alertness/))
* Monitor the patient weekly for the first few weeks.
* Re-emphasize that patients with sleep disturbances should continue to engage in sub-symptom threshold cognitive and physical activities that pose no/low risk of sustaining a concussion (no risk of contact, collision, or falling) as tolerated ([Recommendation 2.3](https://pedsconcussion.com/domain/2/#rec-614)).
...
Tool: [Predicting Persistent Post-Concussive Problems in Pediatrics (5P): Score Calculator](http://www.5pconcussion.com/en/scorecalculator).
...
Tool 10.1: [Post-Concussion Vision, Vestibular, and Oculomotor Disturbances Algorithm](https://pedsconcussion.com/tool-10-1post-concussion-vision-vestibular-and-oculomotor-disturbances-algorithm/).

Tool 2.1: [Physical examination](https://pedsconcussion.com/pedsconcussion-physical-examination/).

[Recommendation 2.1c](https://pedsconcussion.com/domain/2/#rec-202): When to consider diagnostic brain or cervical spine imaging.
...
* Link: [Visio-Vestibular Examination](https://pedsconcussion.com/vve) (The Children’s Hospital of Philadelphia).
...
* Link: [Dix-Hallpike Test](https://pedsconcussion.com/dixhallpike/)  (University of Calgary)
* Link: [Epley Manoeuvre](https://pedsconcussion.com/epley/) (University of Calgary)
...
* Link: [Head Thrust Test and Dynamic Visual Acuity](https://pedsconcussion.com/head-tt) (University of Calgary)
* Link: [Visio-Vestibular Examination](https://pedsconcussion.com/vve) (The Children’s Hospital of Philadelphia)
* Link: [Dynamic Visual Acuity](https://pedsconcussion.com/dva) (University of Calgary)
...
* Link: [Visio-Vestibular Examination](https://pedsconcussion.com/vve) (The Children’s Hospital of Philadelphia)
* Link: [Balance Error Scoring System](https://pedsconcussion.com/bess/) (The University of North Carolina at Chapel Hill)
* Link: [Functional Gait Assessment](https://pedsconcussion.com/gait/) (University of Calgary)
...
Domain 8: [Mental Health and Psychosocial Factors](https://pedsconcussion.com/section/b/#domain-8).
...
* Recommendation 2.3: [Recommend graduated return to cognitive and physical activity](https://pedsconcussion.com/domain/2/#rec-614).
* Recommendation 2.4c: [Advise on the use of computers, phones, and other screen devices](https://pedsconcussion.com/domain/2/#rec-292).
* Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12).
...
* Use a risk score to assess any modifiers that may delay recovery ([Recommendation 2.1b](https://pedsconcussion.com/domain/2/#rec-200)).
* A mental health assessment and a closer look at the family may be recommended (Domain 8: [Mental Health](https://pedsconcussion.com/section/b/#domain-8)).
* Vision, vestibular, and hearing assessments may be recommended (Domain 10: [Vision, Vestibular, and Oculomotor Function](https://pedsconcussion.com/section/b/#domain-10)).
* Physical examination (Tool 2.1: [Physical Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/)).
...
See Domain 3: [Medical Follow-up and Management of Prolonged Symptoms](https://pedsconcussion.com/section/a/#domain-3).

See Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12) for suggestions to guide an initial discussion about the best pathways for the student in school, employment, sports, social, and home environments. Tools and tests should be used in conjunction with an examination of previous school records such as marks and teacher observations.
...
* Emphasize that spreading activities throughout the day helps patients achieve more and that they should avoid doing too much at once.
  * Tool 2.5 [“Four P’s” – Prioritize, Plan, Pace and Position](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-2.5-Four-Ps-Prioritize-Plan-Pace-and-Position-draft.pdf).
...
* Encourage a gradual return to school with accommodation (Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12)).
...
Tool 2.6: [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/) for examples of low-risk activities.
...
Tool 1.1: [Pediatric Concussion- The Role of School Boards, Community Sports Organizations, and Community Centres](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-1.1-Pediatric-Concussion-The-Role-of-School-Boards-Community-Sports-Organizations-and-Centres-09.2019.pdf)
...
* In any child/adolescent who sustains a significant impact to the head, face, neck, or body and demonstrates/exhibits any of the visual signs of a suspected concussion or reports any symptoms of a suspected concussion as detailed in the [Concussion Recognition Tool 6](https://pedsconcussion.com/crt6/) (Tool 1.2).
...
* Concussion [Recognition Tool 6](https://pedsconcussion.com/recognition/) (Tool 1.2)
* [Living Guideline Patient Information Sheet](https://pedsconcussion.com/return-to-activity-sport-school/) (includes return to sport/activity and school protocols)
* Link: [Parachute Concussion Guidelines for Parents & Caregivers](http://www.parachutecanada.org/downloads/resources/Concussion-Parents-Caregivers.pdf) (handout- Parachute Canada) (UPDATE IN PROGRESS)
* Link: [Concussion Ed – Parachute Concussion Education](http://www.parachutecanada.org/injury-topics/item/2587) (app- Parachute Canada)
* Link: [PAR Concussion Recognition & Response](https://www.parinc.com/Products/Pkey/70): Concussion symptom recognition tool for coaches and parents (app)
* Link: [CATT: Concussion Resources for School Professionals](https://resources.cattonline.com/files/concussion-information-package-for-school-professionals) (handout)
* Link: [CATT Concussion Resources for Coaches](https://resources.cattonline.com/files/concussion-information-package-for-coaches) (handout)

1.3

**Recommend an emergency medical assessment for a child/adolescent with any of the “red flag” symptoms.** 

If a child/adolescent demonstrates any of the ‘Red Flags’ symptoms indicated by the [Concussion Recognition Tool 6](https://pedsconcussion.com/crt6/), a more severe head or spine injury should be suspected and an emergency medical assessment is required. **These red flag symptoms may appear immediately or within a few hours or days after injury.** Delayed red flag symptoms require urgent medical assessment as they may indicate a more severe injury. Consider arranging an ambulance service as necessary to facilitate urgent medical assessment at the nearest hospital and execution of the Emergency Action Plan for your organization. When calling an ambulance, describe the specific red flags symptoms over the phone.
...
* Tool 1.2 [Concussion Recognition Tool 6](https://pedsconcussion.com/recognition/) (handout)
* Link: [Concussion Ed – Parachute Concussion Education](http://www.parachutecanada.org/injury-topics/item/2587) (app)
* Link : [PAR Concussion Recognition & Response](https://www.parinc.com/Products/Pkey/70) (app)
...
* Tool 1.2: [Concussion Recognition Tool 6](https://pedsconcussion.com/recognition/)
* Tool 1.3: [Manage Acute and Prolonged Concussion Symptoms Algorithm](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-1.3-Manage-Acute-and-Prolonged-Concussion-Symptoms-Algorithm.pdf)
...
* Sport Concussion Assessment Tool 6 ([SCAT6 13+yrs](https://pedsconcussion.com/scat/) and [Child SCAT6 8-12yrs](https://pedsconcussion.com/scat-child/)) – for experienced healthcare professionals to suspect a concussion:
...
* [2023 American Congress of Rehabilitation Medicine Diagnostic Criteria for mTBI.](https://pedsconcussion.com/diagnostic_criteria/) Link to original paper: [ACRM Criteria for Mild Traumatic Brain Injury (Figure 2 and box 1 and 2)](https://www.archives-pmr.org/article/S0003-9993(23)00297-6/fulltext)
* [Living Guideline Manage Acute and Prolonged Symptoms Algorithm](https://pedsconcussion.com/manage-acute-and-prolonged-concussion-symptoms-algorithm/)
* [Definition of Sport-related Concussion: 6th Consensus Statement on Concussion in Sport](https://bjsm.bmj.com/content/57/11/695)
...
* [ACRM Diagnostic Criteria](https://pedsconcussion.com/diagnostic_criteria/)
* [5P Score Calculator](https://www.5pconcussion.com/en/scorecalculator): Validated tool identify children and youth for risk of persisting symptoms after concussion

**Online resources to consider:**

Standardized symptom inventory tools to consider:

* [Post-Concussion Symptom Inventory (PCSI) Self-Assessment](https://childrensnational.org/-/media/cnhs-site/files/healthcare-providers/cnhn/fop-2016/june20/10gioiapeds-pcp-handout.pdf?la=en&hash=B696AEB4EBCF98C9524B606AD269F95BE615063E) (age 5-7, 8-12, age 13-18)
* Sport Concussion Assessment Tool 6 ([SCAT6](https://pedsconcussion.com/scat/)13+yrs and [Child SCAT6](https://pedsconcussion.com/scat-child/) 8-12yrs)
* Sport Concussion Office Assessment Tool ([SCOAT6 13+ yrs](https://pedsconcussion.com/scoat/) and [Child SCOAT6](https://pedsconcussion.com/scoat-child/https://pedsconcussion.com/scoat-child/) 8-12 yrs)
* [Acute Concussion Evaluation (ACE)](https://www.cdc.gov/heads-up/media/pdfs/providers/ace_v2-a.pdf)
...
* Mental status.
* [Tool: Living Guideline Core Physical Examination: Neurological and Cervical Spine Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/)
...
* [Living Guideline Core Physical Examination: Neurological and Cervical Spine Examination](https://pedsconcussion.com/pedsconcussion-physical-examination/)
* Sport Concussion Assessment Tool 6 ([SCAT6](https://pedsconcussion.com/scat/)13+yrs and [Child SCAT6](https://pedsconcussion.com/scat-child/) 8-12yrs)
* Sport Concussion Office Assessment Tool 6 ([SCOAT6 13+ yrs](https://pedsconcussion.com/scoat/) and [Child SCOAT6](https://pedsconcussion.com/scoat-child/) 8-12 yrs)
* [Heads Up to Health Care Professionals](https://www.cdc.gov/heads-up/hcp/training/index.html) (CDC)
...
* Tool 2.2: [PECARN Management Algorithm for Children after Head Trauma](https://pedsconcussion.com/pecarn-head/).
* Tool 2.3: [CATCH2 Rule](https://pedsconcussion.com/tool-2-3-the-canadian-assessment-of-tomography-for-childhood-head-injury-2-catch2-rule/)
* Tool 2.4: [Algorithm for the Management of the Pediatric Patient ≥ 2 years with Minor Head Trauma](https://pedsconcussion.com/tool-2-4-algorithym-for-the-management-of-the-pediatric-patient-2-years-with-minor-head-trauma/)
...
* **Tool 2.0: [Living Guideline Return to Activity Sports and School Protocol](https://pedsconcussion.com/return-to-activity-sport-school/)**
...
* Return to school should be step-wise as soon as the student is able and include temporary academic modifications based on the student’s symptom tolerance. See Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12) for more recommendations and a list of return-to-school resources.

Level of Evidence: ![](https://pedsconcussion.com/wp-content/uploads/2019/07/Level-B.png)

Online tools to consider:

* [Living Guideline Patient Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/)
* Link: Advice for gradually resuming intellectual, physical and sports activities [English](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_pamphlet_Mild-traumatic-brain-injury.pdf)/ [French](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_Depliant_TCCL_INESSS.pdf) (INESSS)
* Link: [After a Concussion: Return to Sport Strategy](https://www.cdc.gov/heads-up/guidelines/returning-to-school.html) (Parachute Canada) (Updated in progress)
* Link: [HEADS UP Resources for Returning to School](https://www.cdc.gov/headsup/schools/parents.html) (CDC)
* Link: [Return to Activity Strategy](https://resources.cattonline.com/files/return-to-activity-strategy) (CATT)
* Link: [Return-to-School Strategy](https://resources.cattonline.com/files/return-to-school-strategy) (CATT)
* Link: [Return to Sport Strategy](https://resources.cattonline.com/files/return-to-sport-strategy)(CATT)
* Link: [Return to School Strategy](https://parachute.ca/wp-content/uploads/2019/06/Return-to-School-Strategy.pdf) (Parachute) (Updated in progress)
...
* Tool 2.0: [Living Guideline Return to Activity Sports and School Protocol](https://pedsconcussion.com/return-to-activity-sport-school/) (Updated Sept 2023)
...
\*Relative rest: activities of daily living including walking and other light physical and cognitive activities are permitted as tolerated. (this definition has been harmonized with and adapted from the Amsterdam [International Consensus Statement on Concussion in Sport](https://bjsm.bmj.com/content/57/11/695))

See [Living Guideline Return to Sport/Activity and School Protocols](https://pedsconcussion.com/return-to-activity-sport-school/)
...
\*\**More than mild and brief* symptom exacerbation: An increase in current concussion symptoms of no more than 2 points on a 0-10 point scale for less than an hour compared to the resting value prior to the physical activity. Example of a 0-10 point Symptom severity scale: [Visual Analog Scale (VAS)](https://ubortho.com/wp-content/uploads/2020/08/VAS.jpg)

(these definitions have been harmonized with and adapted from the [Amsterdam International Consensus Statement on Concussion in Sport](https://bjsm.bmj.com/content/57/11/695))

* Avoid activities associated with a risk of contact, fall, or collisions ([Recommendation 2.3c](https://pedsconcussion.com/domain/2/#rec-288)).
* [Living Guideline Return to Activity, Sports, and School Protocol](https://pedsconcussion.com/return-to-activity-sport-school/) (Updated Sept 2023)
* 0-10 point Symptom severity [Visual Analog Scale (VAS)](https://ubortho.com/wp-content/uploads/2020/08/VAS.jpg)
* Emphasize that spreading activities throughout the day helps patients achieve more. Tool 2.5: [“Four P’s” – Prioritize, Plan, Pace, and Position.](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-2.5-Four-Ps-Prioritize-Plan-Pace-and-Position-draft.pdf)
* Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12).
* Tool 2.6: [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/) (includes the return to activity, sports, and school protocol). (Updated Sept 2023)
* [Resources](https://pedsconcussion.com/tools-resources/community-resources/): List of other evidence-based return to activity/sports strategy resources
...
4. 0-10 point Symptom severity [Visual Analog Scale (VAS)](https://ubortho.com/wp-content/uploads/2020/08/VAS.jpg)
...
* Tool 2.7: [Strategies to Promote Good Sleep and Alertness](https://pedsconcussion.com/tool-2-7-strategies-to-promote-good-sleep-and-alertness/)
* Link: [Sleep for Youth. CHEO Sleep Hygiene handout](https://pedsconcussion.com/cheo-sleep-for-youth/)
* Link: [Concussion Handbook](http://www.hollandbloorview.ca/concussionhandbook)  (Holland Bloorview Kids Rehabilitation Hospital)
...
* Living Guideline [Post-Concussion Information Sheet](https://pedsconcussion.com/tool-2-6-post-concussion-information-sheet/)
...
* Information on how and when to make a gradual return-to-school and low-risk physical activities. ([Living Guideline Return to Activity/Sport and School Protocol](https://pedsconcussion.com/return-to-activity-sport-school/)
  * (Domain 12: [Return-to-School and Work](https://pedsconcussion.com/section/b/#domain-12); Recommendation 2.3: [Recommend a graduated return to physical and cognitive activity](https://pedsconcussion.com/domain/2/#rec-614)).
* Information on when a medical follow-up appointment is needed  ([Recommendation 2.8](https://pedsconcussion.com/domain/2/#rec-298)).

Other patient information handouts to consider:

* Link: [Canadian Guideline on Concussion in Sport Medical Assessment Letter](http://www.parachutecanada.org/downloads/injurytopics/Medical-Assessment-Letter_Parachute.pdf) (Parachute Canada).
* Link: [Montreal Children’s Hospital discharge instructions](https://www.thechildren.com/sites/default/files/PDFs/Trauma/ConcussionKitInfo/16023e_pad_-_md_discharge_form_web.pdf).
* Link : Institut national d’excellence en sante et en services sociaux (INESSS- Québec). Advice for gradually resuming intellectual, physical and sports activities.  [English](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_pamphlet_Mild-traumatic-brain-injury.pdf) / [French](https://www.inesss.qc.ca/fileadmin/doc/INESSS/Rapports/Traumatologie/INESSS_Depliant_TCCL_INESSS.pdf)
* Link: [CDC: Heads UP Discharge Instructions](https://www.cdc.gov/traumaticbraininjury/pdf/tbi_patient_instructions-a.pdf).
* Link: [Concussion & You Handbook: Holland Bloorview Kids Rehabilitation Hospital](http://www.hollandbloorview.ca/concussionhandbook).
* Link: [Understanding and Managing Concussion in Youth: 3rd Edition Concussion Kit: Montreal Children’s Hospital](https://www.thechildren.com/sites/default/files/PDFs/Trauma/ConcussionKitInfo/16023-e_concussion_kit-brochure_web_spread.pdf).
...
* Tool 2.0: [Living Guideline Return to School and Learn Protocol](https://pedsconcussion.com/return-to-activity-sport-school/) (UPDATED SEPT 2023)
* Tool 12.1: [Concussion Implications and Interventions for the Classroom](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-12.1-Concussion-Implications-and-Interventions-for-the-Classroom.pdf)
* Tool 12.2: [Template: Letter of Accommodation from the concussion care team to the school](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-12.2-Template-for-Concussion-Team_Letter-to-the-Child_Adolescent_School.pdf)
* Tool 12.3: [Template Letter of Accommodation from Physician to School](https://pedsconcussion.com/wp-content/uploads/Tool-12.3-Template-for-Physician_Letter-to-the-Child_-Adolescent_School.pdf)
* Tool 12.4: [Sample Letter/Email from School to Parents](https://pedsconcussion.com/wp-content/uploads/Tool-12.4-Sample-Letter_Email-from-School-to-Parents.pdf)
* Link: [CATT Return to School Strategy](https://resources.cattonline.com/files/return-to-school-strategy)
* Link: [CATT Student Return to Learn Plan](https://resources.cattonline.com/files/student-return-to-learn-plan)
* Link: [Heads Up Schools: Helping Students Recover from a Concussion: Classroom Tips for Teachers](https://www.cdc.gov/heads-up/media/pdfs/schools/TBI_Classroom_Tips_for_Teachers-a.pdf)
* Link: [Parachute’s Protocol for Return to Learn After a Concussion](https://parachute.ca/wp-content/uploads/2019/06/Return-to-School-Strategy.pdf)  (Parachute Canada)
* Link: [Post-Concussion Academic Accommodation Protocol](https://cbirt.org/sites/cbirt.org/files/resources/504_plan_ocamp.pdf)   (University of Oregon)
* Link: [SCHOOLFirst: Enabling successful return to school for Canadian youth following a concussion](https://hollandbloorview.ca/services/programs-services/concussion-centre/concussion-education/schoolfirst) (Holland Bloorview Kids Rehabilitation Hospital)
...
* Tool 2.0: [Living Guideline Return to School Protocol](https://pedsconcussion.com/return-to-activity-sport-school/) (UPDATED SEPT 2023)
* Tool 12.1: [Concussion Implications and Interventions for the Classroom](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-12.1-Concussion-Implications-and-Interventions-for-the-Classroom.pdf)
* Tool 12.2: [Template: Letter of Accommodation from the concussion care team to the school](https://pedsconcussion.com/wp-content/uploads/2019/07/Tool-12.2-Template-for-Concussion-Team_Letter-to-the-Child_Adolescent_School.pdf)
* Tool 12.3: [Template Letter of Accommodation from Physician to School](https://pedsconcussion.com/wp-content/uploads/Tool-12.3-Template-for-Physician_Letter-to-the-Child_-Adolescent_School.pdf)
...
* Domain 8: [Mental Health](https://pedsconcussion.com/section/b/#domain-8)
* Domain 9: [Cognition](https://pedsconcussion.com/section/b/#domain-9)
* Domain 10: [Vision, Vestibular, and Oculomotor Function](https://pedsconcussion.com/section/b/#domain-10)
...
Refer to an interdisciplinary concussion team and/or a school-based educational professional (if available) if symptoms interfere with daily functioning more than 4 weeks following a concussion (Domain 9: [Cognition](https://pedsconcussion.com/section/b/#domain-9)). Refer for a formal evaluation if school difficulties may have been pre-existing.
...
* Tool 12.3: [Template Letter of Accommodation from Physician to School](https://pedsconcussion.com/wp-content/uploads/Tool-12.3-Template-for-Physician_Letter-to-the-Child_-Adolescent_School.pdf)
* Tool 12.4: [Sample Letter/Email from School to Parents](https://pedsconcussion.com/wp-content/uploads/Tool-12.4-Sample-Letter_Email-from-School-to-Parents.pdf)
* Link: [SCHOOLFirst Handbook: Enabling successful return to school for Canadian youth following a concussion](https://hollandbloorview.ca/services/programs-services/concussion-centre/concussion-education/schoolfirst), page 6 (Holland Bloorview Kids Rehabilitation Hospital)
...
See Domain 4: [Medical clearance for full-contact sport or high-risk activity](https://pedsconcussion.com/section/a/#domain-4).
...
* Link: [Tools Supporting Young Children](https://coco.umontreal.ca/en/coco-tools/) (COCO, University of Montreal)
* COCO Early childhood detection tool ([English](https://pedsconcussion.com/coco_detection_tool_eng_2025/), [French](https://pedsconcussion.com/coco_3_outil-de-detection_2025/))
* Link: [COCO Educational kit, University of Montreal](https://coco.umontreal.ca/en/coco-educational-kit-form/)
* [Concussion Recognition Tool-6](https://pedsconcussion.com/recognition/)
...
Link: [Vision, Vestibular and Oculomotor Function](https://pedsconcussion.com/section/managing/#domain-vestibular_oculomotor)
